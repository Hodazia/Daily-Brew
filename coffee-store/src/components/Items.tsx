      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <motion.button
              ...
              className={`px-6 py-3 rounded-full 
                ...
                activeTab === tab.id
                  ...
                  : 'bg-white text-orange-400 hover:bg-orange-200'
              }`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {products[activeTab as keyof typeof products].map((product) => (
            ...
            overflow-hidden border-amber-100">
              ...
              <CardContent className="p-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-lg font-bold text-orange-300">
                    {product.price}</span>
                  <button className="bg-orange-100 text-orange-400
                   px-4 py-2 rounded-full text-sm hover:bg-orange-400
                   hover:text-white
