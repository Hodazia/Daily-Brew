                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute -bottom-6 -right-6
                         bg-orange-100 p-6 rounded-2xl shadow-xl z-10">
                    ...
                    <div className="space-y-6">
                        ...
                        Founded in 2023, Daily Brew has been serving the finest artisanal coffee and handcrafted treats to our beloved community. We source our beans directly from sustainable farms, ensuring every cup tells a story of quality and ethical practices.
                        </p>
                        ...
                        <div className="grid grid-cols-2 gap-6 mt-8 text-amber-800">
                        <div className="text-center p-4 bg-orange-100 rounded-xl shadow-md">
                            <div className="text-2xl font-bold text-coffee-600 mb-2">50+</div>
                            <div className="text-sm text-amber-800">Coffee Varieties</div>
                        </div>
                        <div className="text-center p-4 bg-orange-100 rounded-xl shadow-md">
                            <div className="text-2xl font-bold text-coffee-600 mb-2">1000+</div>
                            <div className="text-sm text-amber-800">Happy Customers</div>
                        </div>
                        </div>
                    </div>
                </div>
